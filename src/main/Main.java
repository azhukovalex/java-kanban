...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task2 = taskManager.saveSingleTask(new SingleTask("Задача2", "Описание2"));
        ...
        taskManager.updateSingleTask(new SingleTask(task1.getId(), task1.getTitle(), task1.getDescription(), Status.IN_PROGRESS)); //смена статуса задачи1
        taskManager.updateSingleTask(new SingleTask(task2.getId(), task2.getTitle(), task2.getDescription(), Status.DONE)); //смена статуса задачи2
